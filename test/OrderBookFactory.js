...
const usd = ethers.utils.parseUnits("0.01", 18);
...
const ORDER_BOOK_STORAGE = '0xc5320D817d9C0BBe8f318C327c614D9617E01fd9';
...
async function collectDataForRequest() {
    ...
    await CheckOrderLength3(ORDER_BOOK_STORAGE, XYZ)
