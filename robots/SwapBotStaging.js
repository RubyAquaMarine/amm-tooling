...
const wallet = new ethers.Wallet(credentials.account.privateKey3);
const account = wallet.connect(provider);

const routerAddress = config.ammv3.router;
const baseToken = config.assets.staging_europa.USDP;

//--------------------------------------ADJUST-----------------------------------||
// When swapping ETH to BTC : smallest value of ETH '0.0000001'
// AMM[A -> USDP -> B] (v1 - multihop)
const fromToken = config.assets.staging_europa.BTC;
const toToken = config.assets.staging_europa.RUBY;
