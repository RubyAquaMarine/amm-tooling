...
async function testRouter() {
    ...
    const tokenOut2 = await routerContract.getAmountsOut(tokenOut[1], [StableAddress.USDP, AssetAddress.ETH]).then(result => {
        console.log("getAmountsOut Result: ", result);
        return result;
    }).catch(err => {
        console.log("getAmountsOut Error: ", err);
    ...
    await doApproval(rubyAmount, AssetAddress.RUBY, ammRouterAddress).then(result => {
