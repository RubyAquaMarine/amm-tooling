...
const contractETH = config.assets.fancy.BTC;

//wrapper
const contract = '0x7E1fF765F547F0a8E878E04D9d9161f6e8cADcfB'; // BTCWRAP 8 decimals

const amount = ethers.utils.parseUnits("0.01", 8);
