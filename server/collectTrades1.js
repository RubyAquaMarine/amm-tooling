...
// only for the amm module ** for 1 rpc call.  
// redesign 
// stable swap fees amd trading volume function can be created into an other module. 
...
async function run() {
    setInterval(collectDataForRequest, 60000 * 1)// 60 sec
}
